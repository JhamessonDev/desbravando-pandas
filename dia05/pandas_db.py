...
# %%
df_01.to_sql('tb_df_01', engine, index=False)

# %%
df_02.to_sql('tb_df_01', engine, index=False, if_exists='append')

# %%
df_02.to_sql('tb_df_01', engine, index=False, if_exists='replace')